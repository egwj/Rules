...
function applyProxyGroups(config) {
  ...
  const groups = [
    ...
    group('🎬 Streaming', ['🔰 Proxy', '🇭🇰 Hong Kong', '🇨🇳 Taiwan', '🇸🇬 Singapore', '🇯🇵 Japan', '🇺🇸 America', '🇬🇧 United Kingdom', '🇰🇷 Korea', '🇦🇺 Australia']),
    group('📺 CNTV', ['🔘 DIRECT', '🔰 Proxy', '🇨🇳 Taiwan', '🇭🇰 Hong Kong']),
    group('🍏 Apple TV', ['🇺🇸 America', '🔰 Proxy', '🇭🇰 Hong Kong', '🇨🇳 Taiwan', '🇯🇵 Japan']),
    group('🍎 Apple', ['🔘 DIRECT', '🔰 Proxy', '🇺🇸 America', '🇯🇵 Japan']),
    group('🔍 Google', ['🔘 DIRECT', '🔰 Proxy', '🇺🇸 America']),
    group('🤖 AIGC', ['🇺🇸 America', '🇸🇬 Singapore', '🔰 Proxy']),
    group('🪙 Crypto', ['🇺🇸 America', '🔰 Proxy', '🔘 DIRECT']),
    group('💳 Credit', ['🇺🇸 America', '🔰 Proxy', '🔘 DIRECT']),
    group('📬 Telegram', ['🔰 Proxy', '🇸🇬 Singapore', '🔘 DIRECT']),
    group('📧 Mail', ['🔰 Proxy', '🔘 DIRECT']),
